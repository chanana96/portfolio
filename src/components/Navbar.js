...
import navbarData_en from "../content/en/navbar.json";
import navbarData_ko from "../content/ko/navbar.json";
...
const Navbar = () => {
  ...
  const navbarData = i18n.language === "en" ? navbarData_en : navbarData_ko;
  const drawer = (
    <>
      <Button
