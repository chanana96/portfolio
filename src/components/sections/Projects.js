...
import projects_en from "../../content/en/projects.json";
import projects_ko from "../../content/ko/projects.json";
...
const Projects = () => {
  ...
  const projects = i18n.language === "en" ? projects_en : projects_ko;
  return (
