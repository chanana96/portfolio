...
import hobbies_en from "../../content/en/hobbies.json";
import hobbies_ko from "../../content/ko/hobbies.json";

import { motion } from "framer-motion";
import { useInView, InView } from "react-intersection-observer";
import * as Scroll from "react-scroll";
import { LiftingSvgPath, ChessSvgPath, SC2SvgPath } from "../SvgHelper";
import "animate.css";
...
const Hobbies = () => {
  ...
  const hobbies = i18n.language === "en" ? hobbies_en : hobbies_ko;
  return (
